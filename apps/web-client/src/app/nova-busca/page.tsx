...
function NovaBuscaContent() {
  ...
  const [logradouro, setLogradouro] = useState(
    () => searchParams.get("logradouro") ?? "RUA DESEMBARGADOR JORGE FONTANA"
  );

  const [numero, setNumero] = useState(
    () => searchParams.get("numero") ?? "200"
  );
          ...
          <HeroGrid>
            <HeroCard>
              <HeroContent>
                ...
                <HeroSubtitle>
                  A prévia entra em uma fila segura do 1RIBH. Mesmo se você
                  sair da tela, ela continua processando e poderá ser revisada
                  depois.
                </HeroSubtitle>
