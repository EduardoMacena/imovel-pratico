  ...
  async function handleCancelarLink(linkId: string) {
    ...
    try {
      ...
      setErro(
        error instanceof Error
          ? error.message
          : "Erro desconhecido ao cancelar link"
      );
    } finally {
          ...
          <HeaderGrid>
            <HeaderContent>
              ...
              <Subtitle>
                ...
                REGISTRO e CND na máquina do cliente sem expor tokens permanentes.
              </Subtitle>
            </HeaderContent>
          ...
          <ContentGrid>
            <MainColumn>
              ...
              <PanelCard>
                <PanelHeader>
                  <div>
                    <PanelTitle>Histórico de links</PanelTitle>
                    <PanelSubtitle>
            ...
            <SideColumn>
              ...
              <PanelCard>
                ...
                <List>
                  <ItemCard>
                    <ItemTitle>1. Admin gera o link</ItemTitle>
                    <ItemMuted>
                      O link contém apenas um código temporário, não o token real
                      do Agent.
                    </ItemMuted>
                  </ItemCard>

                  <ItemCard>
                    <ItemTitle>2. Instalador ativa o código</ItemTitle>
                    <ItemMuted>
                      A API valida expiração, status e uso único antes de criar
                      os tokens.
                    </ItemMuted>
                  </ItemCard>

                  <ItemCard>
                    <ItemTitle>3. Agent envia heartbeat</ItemTitle>
                    <ItemMuted>
                      Depois da instalação, o Monitoramento passa a mostrar
                      REGISTRO e CND online.
                    </ItemMuted>
                  </ItemCard>
                </List>
              </PanelCard>
