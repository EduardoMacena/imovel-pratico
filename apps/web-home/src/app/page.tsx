...
const webClientUrl = process.env.NEXT_PUBLIC_WEB_CLIENT_URL ?? "http://localhost:3001";

const webAdminUrl = process.env.NEXT_PUBLIC_WEB_ADMIN_URL ?? "http://localhost:3002";

const agentWindowsDownloadUrl =
	process.env.NEXT_PUBLIC_AGENT_WINDOWS_DOWNLOAD_URL ??
	"https://staging.imovelpratico.com/downloads/ImovelPraticoAgentSetup-Staging.exe";
...
const plans = [
	{
		name: "Start",
		description:
			"Para imobiliárias pequenas que querem iniciar a captação ativa com organização.",
	...
	},
	{
		name: "Growth",
		description:
			"Para equipes em crescimento que precisam de mais volume comercial todos os meses.",
	...
	},
	{
		name: "Business",
		description:
			"Para operações estruturadas que querem previsibilidade, escala e controle de consumo.",
	...
	},
	{
		name: "Premium",
		description:
			"Para imobiliárias de alto volume com equipe maior e captação comercial intensa.",
		limit: "1.000 consultas inclusas",
		brokers: "Até 26 corretores",
		overage: "R$ 1,70 por consulta adicional",
		price: "R$ 1.797/mês",
	...
	return (
		<PageShell>
			...
			<FloatingNav>
				<NavInner>
					...
					<NavActions>
						...
						<NavGhost href={agentWindowsDownloadUrl} download>
							Baixar Agent
						</NavGhost>
			...
			<HeroSection>
				<HeroGrid>
					<HeroContent>
						<Overline>Plataforma premium para captação imobiliária</Overline>

						<HeroTitle>
							Captação imobiliária com{" "}
							<GradientText>escala, dados e velocidade.</GradientText>
						</HeroTitle>

						<HeroDescription>
							O Imóvel Prático transforma uma rotina manual de pesquisa, organização e
							localização de proprietários em um processo profissional para imobiliárias
							que querem crescer com método.
						</HeroDescription>
						...
						<HeroActions>
							...
							<SecondaryButton href={agentWindowsDownloadUrl} download>
								Baixar Agent Windows
							</SecondaryButton>

							<SecondaryButton href="#processo">Entender como funciona</SecondaryButton>
						</HeroActions>
			...
			<SectionBlock id="produto">
				<Reveal>
					<SectionHeader>
						...
						<SectionDescription>
							O Imóvel Prático foi pensado para imobiliárias que já entenderam que
							velocidade de prospecção, organização e dados são vantagens competitivas.
						</SectionDescription>
					</SectionHeader>
				</Reveal>
				...
				<PainGrid>
					<DarkPanel>
						...
						<p>
							O sistema organiza o caminho entre endereço, busca, proprietário, contato e
							exportação. A equipe deixa de trabalhar no improviso e passa a operar com
							método.
						</p>
					</DarkPanel>
			...
			<SectionBlock id="processo">
				<Reveal>
					<SectionHeader>
						...
						<SectionDescription>
							A plataforma simplifica a operação em etapas fáceis de entender, acompanhar
							e repetir.
						</SectionDescription>
					</SectionHeader>
				</Reveal>
			...
			<SectionBlock>
				<Reveal>
					<SectionHeader>
						...
						<SectionTitle>
							Tudo que a imobiliária precisa para operar captação com mais controle.
						</SectionTitle>
						<SectionDescription>
							A home precisa transmitir que existe um produto completo por trás: painel,
							fila, histórico, exportação, usuários, planos e gestão.
						</SectionDescription>
					</SectionHeader>
				</Reveal>
			...
			<PlanSection id="valor">
				<PlanGrid>
					<PlanContent>
						...
						<p>
							Escolha a estrutura ideal para sua equipe. Cada plano combina consultas
							mensais inclusas, quantidade de corretores e cobrança transparente por
							consulta adicional.
						</p>
					</PlanContent>
			...
			<SectionBlock>
				<Reveal>
					<SectionHeader>
						...
						<SectionTitle>
							Feito para imobiliárias que querem captação como processo, não tentativa.
						</SectionTitle>
					</SectionHeader>
				</Reveal>
			...
			<SectionBlock id="faq">
				<Reveal>
					<SectionHeader>
						...
						<SectionDescription>
							A página precisa antecipar dúvidas e reforçar que o produto é operação, não
							apenas software.
						</SectionDescription>
					</SectionHeader>
				</Reveal>
			...
			<FinalCta>
				...
				<p>
					Mostre para sua equipe e para seus clientes que a imobiliária está usando
					tecnologia, processo e inteligência para encontrar melhores oportunidades.
				</p>
			...
			<Footer>
				<span>
					© {new Date().getFullYear()} Imóvel Prático. Todos os direitos reservados.
				</span>
				<span>
